(function() {
    ...
    var find = function*(entitySchema, query, p1, p2, p3) {
        ...
        if (items.length) {
            ...
            for (var i = 0; i < items.length; i++) {
                var item = items[i];
                results.push(yield* ceramic.constructEntity(item, entitySchema, { additionalProperties: ["__updateTimestamp"] }));
            }
            return results;
        } else {
            return [];
    ...
    var findOne = function*(entitySchema, query, p1, p2, p3) {
        ...
        if (result) {
            return yield* ceramic.constructEntity(result, entitySchema, { additionalProperties: ["__updateTimestamp"] });
        }
    };
